...
import { WARNING_VIEW, DELETE_WARNING } from "../../../../../ApiEndPoint/Api";
...
class WarningList extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columnDefs: [
              ...
              <div className="actions cursor-pointer text-center">
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HRMAdminForms/warningVIEW/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
                ...
                {this.state.InsiderPermissions.Edit && (
                  <Edit
                    ...
                    onClick={() =>
                      this.props.history.push({
                        pathname: `/app/ajgroup/HRM/HRMAdminForms/warningEDIT/${params.data?._id}`,
                        state: params.data,
                      })
                    }
                  />
        ...
        {
          headerName: "Warning By",
          field: "warningByEmployeeName",
          filter: true,
          width: 150,
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.warningByEmployeeName?.firstName}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="cursor-pointer text-center">
                <div>
                  <span>{params.data?.warningToEmployeeName?.firstName}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Get(WARNING_VIEW, db, id)
      .then((res) => {
        this.setState({ Loading: false });

        if (res?.warning) {
          this.setState({ rowData: res?.warning });
        }
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(localStorage.getItem("warningList"));
  ...
  async componentDidMount() {
    const InsidePermissions = CheckPermission("Warning");
