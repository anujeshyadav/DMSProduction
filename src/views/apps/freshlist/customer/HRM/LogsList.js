...
import { HRM_DELETE_JOB } from "../../../../../ApiEndPoint/Api";
...
class LogsList extends React.Component {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="">
                <div>{params?.data?.currentTime}</div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="">
                <div>{params?.data?.currentDate}</div>
              </div>
            );
          },
        },
  ...
  async Apicalling(db) {
    ...
    debugger;
    await axios
      .get(`http://13.201.119.216:8050/api/localDataAttendance/` + db)
      .then((res) => {
