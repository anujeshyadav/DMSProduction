...
class SalesPersonTarget extends React.Component {
    ...
    this.state = {
      ...
      columnDefs: [
...

        {
          ...
          field: "achievements.productId.Product_Title",
          filter: true,
          width: 200,
          cellRendererFramework: (params) => {
            console.log(params?.data);
            return (
              <div>
                <span>
                  {params?.data?.achievements?.productId?.Product_Title}
                </span>
              </div>
            );
          },
        },
        {
          ...
          field: "achievements.targetQuantity",
          filter: true,
          width: 200,
          cellRendererFramework: (params) => {
            console.log(params?.data);
            return (
              <div>
                <span>{params?.data?.achievements?.targetQuantity}</span>
              </div>
            );
          },
        },
        {
          ...
          field: "achievements.actualQuantity",
          filter: true,
          width: 200,
          cellRendererFramework: (params) => {
            console.log(params?.data);
            return (
              <div>
                <span>{params?.data?.achievements?.actualQuantity}</span>
              </div>
            );
          },
        },
        {
          ...
          field: "achievements.targetTotalPrice",
          filter: true,
          width: 200,
          cellRendererFramework: (params) => {
            console.log(params?.data);
            return (
              <div>
                <span>{params?.data?.achievements?.targetTotalPrice}</span>
              </div>
            );
          },
        },
        {
          ...
          field: "achievements.actualTotalPrice",
          filter: true,
          width: 200,
          cellRendererFramework: (params) => {
            console.log(params?.data);
            return (
              <div>
                <span>{params?.data?.achievements?.actualTotalPrice}</span>
              </div>
            );
          },
        },
        {
          headerName: "Achieved % ",
          field: "achievements.achievementPercentage",
          filter: true,
          width: 200,
          cellRendererFramework: (params) => {
            console.log(params?.data);
            return (
              <div>
                <span>
                  {params?.data?.achievements?.achievementPercentage?.toFixed(
                    2
                  )}
                </span>
              </div>
  ...
  async componentDidMount() {
    let data = this.props;
    let Alldata = data?.target?.res?.salesPerson?.flatMap((element, index) => {
    ...
    console.log(Alldata);
    let a = 0;
    let selectedtarget = Alldata?.map((ele) => {
      a += Number((ele?.achievements?.achievementPercentage).toFixed(2));
      return ele?.achievements?.achievementPercentage;
    });
    ...
    this.setState({
      ...
      TotalAchievedTarget: totalTarget / selectedtarget?.length,
    });
