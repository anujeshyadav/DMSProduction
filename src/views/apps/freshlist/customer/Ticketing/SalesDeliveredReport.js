...
class SalesDeliveredReport extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  {params.data?.order?.updatedAt &&
                    params.data?.order?.updatedAt?.split("T")[0]}
                </div>
              </div>
            );
          },
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  <span>
                    {params.data?.order?.partyId?.address1}{" "}
                    {params.data?.order?.partyId?.address2}
                  </span>
                </div>
              </div>
            );
        ...
        {
          headerName: "Delivery Through",
          field: "order.transporter.companyName",
          filter: true,
          width: 200,
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  <span>{params.data?.order?.transporter?.companyName}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  <span>{params.data?.order?.vehicleNo}</span>
                </div>
              </div>
            );
          },
...

        {
          ...
          cellRendererFramework: (params) => {
            return params.data?.order.status
              ?.toLowerCase()
              ?.includes("completed") ? (
              <div className="text-center cursor-pointer">Delivered</div>
  ...
  async Apicalling(id, db) {
    ...
    await _Get(view_create_order_history, id, db)
      .then((res) => {
        ...
        let Completed = Alldata?.filter((ele) =>
          ele?.order.status?.toLowerCase()?.includes("completed")
        );
        ...
        let userHeading = JSON.parse(
          localStorage.getItem("salesDeliveredOrderReport")
        );
      ...
      <>
            ...
            <Card>
              <Row className="ml-2 mr-2">
                ...
                <Col xl='5' lg='5' md='5' style={{marginTop:'9px'}}><div className="table-input cssforproductlist">
...
export default SalesDeliveredReport;
