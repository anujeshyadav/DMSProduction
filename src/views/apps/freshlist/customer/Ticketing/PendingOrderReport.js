...
import { Product_Sales_Report } from "../../../../../ApiEndPoint/Api";
...
class PendingOrderReport extends React.Component {
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  <span>{params.data?.taxableAmount?.toFixed(2)}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  <span>{params.data?.cgstRate?.toFixed(2)}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  <span>{params.data?.sgstRate?.toFixed(2)}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="text-center cursor-pointer">
                <div>
                  <span>{params.data?.igstRate?.toFixed(2)}</span>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _Post(Product_Sales_Report, db, id)
      .then((res) => {
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("PRODUCT WISE SALE REPORT");
      ...
      <>
        <Card>
          <Row className="ml-2  mr-2">
            ...
            <Col style={{ marginTop: "30px" }} md="2" lg="2" xl="2">
