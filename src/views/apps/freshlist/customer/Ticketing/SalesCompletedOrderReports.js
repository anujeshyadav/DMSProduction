...
class SalesCompletedOrderReports extends React.Component {
  ...
  async Apicalling(id, db) {
    ...
    await _Get(view_create_order_history, id, db)
      .then((res) => {
        ...
        let userHeading = JSON.parse(localStorage.getItem("SalescompleteorderReport"));
...
export default SalesCompletedOrderReports;
