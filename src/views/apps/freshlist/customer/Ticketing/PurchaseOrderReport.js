      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div>
                <Badge color="primary">{params?.data?.taxableAmount}</Badge>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div>
                <Badge color="primary">{params?.data?.cgstRate}</Badge>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div>
                <Badge color="primary">{params?.data?.sgstRate}</Badge>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: params => {
            return (
              <div>
                <Badge color="primary">{params?.data?.igstRate}</Badge>
              </div>
            );
          },
        },
